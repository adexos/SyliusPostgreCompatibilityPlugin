...
namespace Tests\Adexos\SyliusPostgreCompatibilityPlugin;
...
final class SalesDataProviderTest extends WebTestCase
{
    ...
    private const __VENDOR_DIR__ = __DIR__.'/../../vendor/';
    ...
    protected function setUp(): void
    {
        ...
        $fixtureLoader->load([self::__VENDOR_DIR__ . 'sylius/sylius/tests/DataFixtures/ORM/resources/year_sales.yml'], [], [], PurgeMode::createDeleteMode());
    ...
    /** @test */
    public function it_overrride_the_concrete_sales_provider(): void
    {
        $salesDataProvider = self::$container->get(SalesDataProviderInterface::class);
        $this->assertInstanceOf(SalesDataProvider::class, $salesDataProvider);
    }
